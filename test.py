...
def open_settings():
    ...
    settings_window.geometry("500x700")  # Adjusted size to fit content
...
def create_gui():
    ...
    start_button = Button(button_frame, text="Start", command=start_detection, font=("Arial", 12), bg='#008CBA', fg='#FFFFFF', padx=20, pady=10)
    start_button.grid(row=0, column=0, padx=10)

    exit_button = Button(button_frame, text="Exit", command=close_program, font=("Arial", 12), bg='#F44336', fg='#FFFFFF', padx=20, pady=10)
